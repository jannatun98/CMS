...
@if($errors->any())
  ...
  <label for="crisis_id">Crisis Name</label>
    ...
    <input required id="donate_amount" value="{{$donation->donate_amount}}" type="number" class="form-control" name="donate_amount">
    <label for="payment_method">Payment Method</label>
    <input required id="payment_method" value="{{$donation->payment_method}}" type="text" class="form-control" name="payment_method">
    <label for="transaction_id">Transaction ID</label>
    <input required id="transaction_id" value="{{$donation->transaction_id}}" type="text" class="form-control" name="transaction_id">
  </div>
