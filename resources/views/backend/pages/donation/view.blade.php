...
<div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
    <div class="card p-4">
        <div class=" image d-flex flex-column justify-content-center align-items-center"><span class="name mt-3"><b>Crisis:</b> <a href="{{route('crisis.view',$donate->crisis_id)}}">{{$donate->Crisis->name}}</a></span>
            <div class="d-flex flex-row justify-content-center align-items-center gap-2"><span class="idd1"><b>Donor:</b> <a href="{{route('donor.view',$donate->donor_id)}}">{{$donate->name}}</a></span></div>
