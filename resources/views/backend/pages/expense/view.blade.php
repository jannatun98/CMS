...
<div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
    <div class="card p-4">
        <div class=" image d-flex flex-column justify-content-center align-items-center"><span class=""><b>Crisis:</b> <a href="{{route('crisis.view',$expense->crisis_id)}}">{{$expense->Crisis->name}}</a></span>
            ...
            <div class="d-flex flex-row justify-content-center align-items-center gap-2"><span class="idd1"><b>Volunteer:</b> <a href="{{route('volunteer.view',$expense->volunteer_id)}}">{{$expense->name}}</a></span></div>
            ...
            <div class="d-flex flex-row justify-content-center align-items-center gap-2"><span class="idd1"><b>Amount:</b> {{$expense->amount}}</span></div>
