...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	<div class="container">
		...
		<a class="btn btn-light" href="{{route('user.profile')}}" class="nav-item nav-link">
			{{auth()->user()->name}}</a>
		<a href="{{route('user.logout')}}" class="nav-item nav-link">{{__('Logout')}}</a>
		@else
		...
		<div class="collapse navbar-collapse" id="ftco-nav">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active"><a href="{{route('f.home')}}" class="nav-link">{{__('Home')}}</a></li>
				<!-- <li class="nav-item"><a href="" class="nav-link">{{__('About')}}</a></li> -->

				@auth
				@if(auth()->user()->role =='volunteer')
				<li class="nav-item"><a href="{{route('volunteer.volunteertocrisis')}}" class="nav-link">{{__('Volunteer To Crisis')}}</a></li>
				<li class="nav-item"><a href="{{route('volunteer.expense')}}" class="nav-link">{{__('Expense')}}</a></li>
				@endif
				@endauth
